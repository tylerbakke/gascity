 ...
 */
export const getV0CityByCityNameFleetStatus = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameFleetStatusData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameFleetStatusResponses, GetV0CityByCityNameFleetStatusErrors, ThrowOnError>({ url: '/v0/city/{cityName}/fleet/status', ...options });
